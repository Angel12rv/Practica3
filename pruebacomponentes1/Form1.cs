...
namespace pruebacomponentes1
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            // Usar InputValidator
            string input = "12345";//Aqui se ingresan los numeros o texto que se verificara si son puros numeros
            bool isNumeric = InputValidator.EsSoloNumeros(input);
            MessageBox.Show($"¿Es '{input}' solo números? {isNumeric}");

            // Usar RFCValidator
            string rfc = "ABCD123456XYZ";//Aqui se modifican los datos de la RFC que despues se comprobaran
